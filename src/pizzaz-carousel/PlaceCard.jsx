...
import { Star, Clock } from "lucide-react"; // Added Clock icon

export default function PlaceCard({ place }) {
  if (!place) return null;

  // Get today's hours based on the current day of the week
  ...
  return (
    <div className="min-w-[220px] select-none max-w-[220px] w-[65vw] sm:w-[220px] self-stretch flex flex-col">
      ...
      <div className="mt-3 flex flex-col flex-1">
        ...
        {place.description ? (
          <div className="text-sm mt-2 text-black/80 flex-auto line-clamp-2">
            {place.description}
          </div>
        ) : null}
