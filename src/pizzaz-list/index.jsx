      ...
      <div className="max-w-full">
        <div className="flex flex-row items-center gap-4 sm:gap-4 border-b border-black/5 py-4">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyL-AF_8JA4H8H9idngg26w-uFjcSWvsTV-A&s)",
            }}
          ></div>
          <div>
            <div className="text-base sm:text-xl font-medium">
              National Best Restaurant List
            </div>
            <div className="text-sm text-black/60">
              A ranking of the best Restaurant in the world
            </div>
          </div>
