...
const INITIAL_CART_ITEMS: CartItem[] = [
  {
    ...
    price: 18.50,
    description:
      "Layers of tender pasta, rich meat ragu, and creamy béchamel sauce, baked to perfection with a golden parmesan crust.",
    shortDescription: "Eagle Cafe's signature lasagna",
    detailSummary: "Large portion • Serves 1-2",
    nutritionFacts: [
    ...
    highlights: [
      ...
      "Slow-cooked beef and pork ragu.",
      "Served with garlic bread.",
    ],
    quantity: 2,
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuH8VeX6T0zNHI7TVjIDdIMh9iMko4lguEJQ&s",
    tags: ["size"],
  },
  {
    id: "avocados",
    ...
    price: 12.00,
    description:
      "A stack of three extra-fluffy buttermilk pancakes topped with fresh berries, whipped butter, and warm maple syrup.",
    shortDescription: "Buttermilk stack with berries",
    detailSummary: "3 pancakes • Breakfast served all day",
    nutritionFacts: [
    ...
    highlights: [
      "Made with fresh buttermilk.",
      "Includes pure Vermont maple syrup.",
      "Vegetarian friendly.",
    ],
    quantity: 2,
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2k_J5X3k5Xw0_3k5Xw0_3k5Xw0_3k5Xw0&s",
    tags: ["vegetarian"],
  },
  {
    id: "hojicha-pizza",
    ...
    price: 16.50,
    description:
      "Juicy angus beef patty topped with melted cheddar, caramelized onions, lettuce, tomato, and house secret sauce on a brioche bun.",
    shortDescription: "Angus beef & cheddar",
    detailSummary: '1/2 lb patty • Comes with fries',
    nutritionFacts: [
    ...
    highlights: [
      "Premium Angus beef.",
      "Toasted brioche bun.",
      "Includes crispy seasoned fries.",
    ],
    quantity: 2,
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSmIrSdCsVWEqzEkXxspH69STPU_vNgnkRJQ&s",
    tags: ["size", "spicy"],
  },
  {
    id: "chicken-pizza",
    ...
    price: 28.00,
    description:
      "Chef's selection of fresh nigiri and maki rolls, including tuna, salmon, yellowtail, and spicy tuna rolls.",
    shortDescription: "Chef's choice nigiri & rolls",
    detailSummary: '12 pieces • Miso soup included',
    nutritionFacts: [
    ...
    highlights: [
      "Freshly sourced fish.",
      "Includes wasabi and pickled ginger.",
      "Hand-rolled to order.",
    ],
    quantity: 1,
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9myS5KzmTG4WwRdHWO__Llm_EW2hwXfcbKQ&s",
    tags: ["size"],
  },
  {
    id: "matcha-pizza",
    name: "Creamy Truffle Gnocchi",
    price: 22.00,
    description:
      "Potato gnocchi tossed in a decadent wild mushroom and truffle cream sauce, finished with shaved parmesan and herbs.",
    shortDescription: "Wild mushroom & truffle",
    detailSummary: 'Dinner portion • Vegetarian',
    nutritionFacts: [
    ...
    quantity: 1,
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzdN63X4Og-mEDSKqnJHsdRm_9mfoxUd9iMg&s",
    tags: ["vegetarian"],
  },
  {
    id: "pesto-pizza",
    ...
    price: 14.00,
    description:
      "Three marinated pork tacos served on corn tortillas with pineapple, cilantro, onions, and a side of spicy salsa.",
    shortDescription: "Marinated pork & pineapple",
    detailSummary: '3 tacos • Gluten free corn tortillas',
    nutritionFacts: [
    ...
    highlights: [
      "Traditional spit-roasted pork.",
      "Fresh cilantro and onions.",
      "Served with lime wedges.",
    ],
    quantity: 1,
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYIpUDxEBKjzsIzVUzticwSnW3dZ72qiWCKQ&s",
    tags: ["size", "spicy"],
  },
];
