...
widgets: List[PizzazWidget] = [
    ...
    PizzazWidget(
        ...
        template_uri="ui://widget/booking.html",
        invoking="Opening reservation system",
        invoked="Reservation system ready",
        html=_load_widget_html("booking"),
        response_text="Rendered the booking widget!",
    ),
]
...
class PizzaInput(BaseModel):
    ...
    pizza_topping: str = Field(
        ...,
        alias="foodItem",
        description="Food item, cuisine, or dish to mention when rendering the widget.",
    )
